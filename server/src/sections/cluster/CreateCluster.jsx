    ...
    <Fragment>
      ...
      <Dialog open={open} maxWidth="xs">
        <FormProvider id={formId} methods={methods} onSubmit={handleSubmit(handleConnect)}>
          ...
          <DialogActions>
            {cluster ? (
              <LoadingButton variant="outlined" disabled={!cluster} onClick={handleAddCluster} loading={pending}>
                Thêm
              </LoadingButton>
            ) : (
              <LoadingButton type="submit" form={formId} variant="outlined" disabled={pending} loading={pending}>
                Test
              </LoadingButton>
            )}
