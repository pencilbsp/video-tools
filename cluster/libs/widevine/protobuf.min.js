    ...
    })(
        {
            ...
            2: [
                function (t, n, i) {
                    ...
                    for (var f = Array(64), o = Array(123), r = 0; r < 64; )
                        o[(f[r] = r < 26 ? r + 65 : r < 52 ? r + 71 : r < 62 ? r - 4 : (r - 59) | 43)] = r++;
                    i.encode = function (t, n, i) {
                        ...
                        return (
                            ...
                            u
                                ? (s && u.push(String.fromCharCode.apply(String, e.slice(0, s))), u.join(""))
                ...
                function (t, n, i) {
                    ...
                    ((n.exports = r).prototype.on = function (t, n, i) {
                        ...
                        (r.prototype.off = function (t, n) {
                            ...
                            else for (var i = this.t[t], r = 0; r < i.length; ) i[r].fn === n ? i.splice(r, 1) : ++r;
                            return this;
                        }),
            ...
            4: [
                function (t, n, i) {
                    function r(t) {
                                    ...
                                    : isNaN(n)
                                      ...
                                      : 34028234663852886e22 < n
                                        ...
                                        : n < 11754943508222875e-54
                                          ...
                                          : ((u << 31) |
                                                ((127 + (t = Math.floor(Math.log(n) / Math.LN2))) << 23) |
                                                (8388607 & Math.round(n * Math.pow(2, -t) * 8388608))) >>>
                                            0,
                                i,
                                r,
                            );
                        ...
                        function i(t, n, i) {
                            (t = t(n, i)), (n = 2 * (t >> 31) + 1), (i = (t >>> 23) & 255), (t &= 8388607);
                            return 255 == i
                                ? t
                                    ? NaN
                                    : (1 / 0) * n
                        ...
                        function r(t, n, i) {
                            (h[0] = t), (n[i] = o[0]), (n[i + 1] = o[1]), (n[i + 2] = o[2]), (n[i + 3] = o[3]);
                        }
                        function u(t, n, i) {
                            (h[0] = t), (n[i] = o[3]), (n[i + 1] = o[2]), (n[i + 2] = o[1]), (n[i + 3] = o[0]);
                        }
                        function e(t, n) {
                            return (o[0] = t[n]), (o[1] = t[n + 1]), (o[2] = t[n + 2]), (o[3] = t[n + 3]), h[0];
                        }
                        function s(t, n) {
                            return (o[3] = t[n]), (o[2] = t[n + 1]), (o[1] = t[n + 2]), (o[0] = t[n + 3]), h[0];
                        }
                        var h, o, f, c, a;
                                  ...
                                  : 17976931348623157e292 < r
                                    ...
                                    : r < 22250738585072014e-324
                                      ...
                                      : (t(
                                        ...
                                        t(
                                            ((h << 31) | ((r + 1023) << 20) | ((1048576 * s) & 1048575)) >>> 0,
                                            u,
                                            e + i,
                                        ));
                        }
                        ...
                        (i.write = function (t, n, i) {
                            for (var r, u, e = i, s = 0; s < t.length; ++s)
                                (r = t.charCodeAt(s)) < 128
                                    ...
                                    : (r < 2048
                                          ? (n[i++] = (r >> 6) | 192)
                                          : (55296 == (64512 & r) && 56320 == (64512 & (u = t.charCodeAt(s + 1)))
                                                ? (++s,
                                                  (n[i++] =
                                                      ((r = 65536 + ((1023 & r) << 10) + (1023 & u)) >> 18) | 240),
                                                  (n[i++] = ((r >> 12) & 63) | 128))
                                                : (n[i++] = (r >> 12) | 224),
                                            (n[i++] = ((r >> 6) & 63) | 128)),
                                      (n[i++] = (63 & r) | 128));
            ...
            13: [
                function (t, n, i) {
                    ...
                    (((r.prototype = Object.create(h.EventEmitter.prototype)).constructor = r).prototype.rpcCall =
                        function t(i, n, r, u, e) {
                ...
                function (t, n, i) {
                                ...
                                return 0 === t
                                    ...
                                    : ((i = (t = (n = t < 0) ? -t : t) >>> 0),
                                      ...
                                      n &&
                                          ((t = ~t >>> 0),
                                          (i = ~i >>> 0),
                                          4294967295 < ++i && ((i = 0), 4294967295 < ++t && (t = 0))),
                                      new u(i, t));
                            }),
                            (u.from = function (t) {
                    ...
                    (u.fromHash = function (t) {
                        return "\0\0\0\0\0\0\0\0" === t
                            ? e
                            : new u(
                                  (s.call(t, 0) | (s.call(t, 1) << 8) | (s.call(t, 2) << 16) | (s.call(t, 3) << 24)) >>>
                                      0,
                                  (s.call(t, 4) | (s.call(t, 5) << 8) | (s.call(t, 6) << 16) | (s.call(t, 7) << 24)) >>>
                                      0,
                              );
                    }),
            ...
            15: [
                function (t, n, i) {
                    ...
                    function e(t) {
                        ...
                        return (
                            (i.prototype = Object.create(Error.prototype, {
                                constructor: { value: i, writable: !0, enumerable: !1, configurable: !0 },
                                name: {
                                    get: function () {
                                        return t;
                                    },
                    ...
                    (r.asPromise = t(1)),
                        ...
                        (r.global =
                            (r.isNode && global) ||
                            ("undefined" != typeof void 0 && window) ||
                        ...
                        (r.isset = r.isSet =
                            function (t, n) {
                                ...
                                return (
                                    null != i &&
                                    t.hasOwnProperty(n) &&
                                    ("object" != typeof i || 0 < (Array.isArray(i) ? i : Object.keys(i)).length)
                                );
                            }),
                        (r.Buffer = (function () {
                            try {
                        ...
                        (r.oneOfGetter = function (t) {
                            ...
                            return function () {
                                for (var t = Object.keys(this), n = t.length - 1; -1 < n; --n)
                                    if (1 === i[t[n]] && this[t[n]] !== d && null !== this[t[n]]) return t[n];
                            };
                        }),
            ...
            16: [
                function (t, n, i) {
                    ...
                    function b(t, n, i) {
                        for (; t.hi; )
                            (n[i++] = (127 & t.lo) | 128), (t.lo = ((t.lo >>> 7) | (t.hi << 25)) >>> 0), (t.hi >>>= 7);
                    ...
                    (a.create = l()),
                        ...
                        u.Array !== Array && (a.alloc = u.pool(a.alloc, u.Array.prototype.subarray)),
                        (a.prototype.e = function (t, n, i) {
                            return (this.tail = this.tail.next = new o(t, n, i)), (this.len += n), this;
                        }),
                    ...
                    (a.prototype.bytes = function (t) {
                        var n,
                            i = t.length >>> 0;
                        return i
                            ? (u.isString(t) && ((n = a.alloc((i = s.length(t)))), s.decode(t, n, 0), (t = n)),
                        ...
                        (a.prototype.finish = function () {
                            for (var t = this.head.next, n = this.constructor.alloc(this.len), i = 0; t; )
            ...
            17: [
                function (t, n, i) {
                    ...
                    function s(t, n, i) {
                        t.length < 40 ? u.utf8.write(t, n, i) : n.utf8Write ? n.utf8Write(t, i) : n.write(t, i);
                    }
                    (e.n = function () {
                        (e.alloc = u.u),
                            (e.writeBytesBuffer =
